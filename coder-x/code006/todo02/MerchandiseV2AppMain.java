package code006.todo02;

import code006.todo02.supermarket.MerchandiseV2;

public class MerchandiseV2AppMain {
    public static void main(String[] args) {
        MerchandiseV2 merchandise = new MerchandiseV2();

        merchandise.init("书桌", "DESK9527", 40, 999, 500);
...
//        merchandise.buyDouble(count);
        ...
        double countForOverride  = 10.5;
        merchandise.buy();
        merchandise.buy(2);
        merchandise.buy(2, true);
        merchandise.buy(2.0);
    }
}
