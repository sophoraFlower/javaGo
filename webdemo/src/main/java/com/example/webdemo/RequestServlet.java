...
public class RequestServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        //客户端请求信息
        System.out.println("应⽤上下⽂路径：getContextPath=" + req.getContextPath());
        ...
        System.out.println("客户机发请求使⽤的⽹络端口号：getRemotePort=" + req.getRemotePort());
        //获取请求头
        ...
        System.out.println("客户端请求参数表,多个值：getParameterValues=" + Arrays.toString(sport));
